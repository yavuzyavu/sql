...
--vergi nosu 102 olan tedarikcinin fiirma ismini vestel olarak guncelleyiniz
UPDATE tedarikciler
...
-- 'Adam Eve' olan firmanın ismi (firma_ismi) ile degistirin
-- bu soruda tedarikciler ve urunler tablosunu yeniden olusturduk
update urunler 
set urun_isim =(select firma_isim from tedarikciler where irtibat_isim='Adam Eve')
where musteri_isim= 'Ali Bak';

-- Urunler tablosunda laptop satin alan musterilerin ismini, firma_ismi Apple’in irtibat_isim'i ile degistirin.

UPDATE urunler set urun_isim =(select irtibat_ismi from tedarikciler where firma_ismi = 'Apeple'
