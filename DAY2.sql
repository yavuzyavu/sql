...
-- DELETE FROM tabllo_adi WHERE sutun_adi = veri  --> tablodaki istedigimiz veriyi siler
...
--Soru : ismi Kemal Yasa olan satiri sil

DELETE FROM ogrenciler WHERE isim = 'Kemal Yasa';

-- soru: isimi Nesibe Yılmaz veya Mustafa Bak olan kayitlari sil

DELETE FROM ogrenciler WHERE isim= 'Nesibe Yilmaz' or isim = 'Mustafa Bak';

-- ismi Ali Can ve ıd si 123 olan kaydi siliniz
...
alter table pesonel rename to isciler
...
-- UNIQUE --> BİR SUTUNDAKİ TUM DEGERLERİN  benzersiz YANİ TEK OLMASİNİ SAGLAR
-- NOT NULL --> Bir sutunun NULL icermesini yani bos olmamasini saglar
